...
> - Правило 1 - **Рефлексивность** (множество атрибутов всегда функционально определяет любое из своих подмножеств.)
> - Правило 2 - **Пополнение** (добавление одного и того же множества атрибутов и к левой, и к правой частям функциональной зависимости приводит к получению еще одной действительной зависимости.)
> - Правило 3 - **Транзитивность** (функциональные зависимости являются транзитивными.)
> - Правило 4 - **Объединение** (в процессе проектирования может быть выполнена обратная операция, при которой ряд зависимостей с одинаковыми левыми частями А -> В, А -> С и A -> D объединяется в одну функциональную зависимость А->В,С, D.)
> - Правило 5 - **Декомпозиция** (определяет, что можно удалять атрибуты из правой части зависимости.)
> - Правило 6 - **Псевдотранзитивность**
